        ...
        <>
            {isLoading ? ( 
                ...
                <div className='singleRoomcontainer'>
                    ...
                    <div className='roomImage'>
                        <div className='room'>
                            {imageLoading && <div className="shimmer-wrapper"><div className="shimmer"></div></div>}
                            <img
                                className='singleImg'
                                src={singleRoom.images[0]}
                                alt=""
                                loading="lazy"
