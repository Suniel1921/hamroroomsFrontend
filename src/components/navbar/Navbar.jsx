...
const Navbar = () => {
  ...
  const openPostYourRoomModal = () => {
    if (auth.user) {
      ...
      setIsModalOpen(false); // Close the main modal if it's open
      setIsLoginModalOpen(true); // Show the login modal if user is not logged in
      toast.error("Please Login First");
    }
  };
  ...
  return (
    <>
          ...
          <div className="postYourRoom" onClick={openPostYourRoomModal}>
            <NavLink>
              <div className="plusicon">
                ...
                <span className="postYourRoomText">Post Your Room</span>
              </div>
            </NavLink>
          </div>
          ...
          <div className="popUp_login_signup">
            {auth.user ? (
              <>
                ...
                <hr />
                <br />
                <NavLink to={"/account"} onClick={() => setIsModalOpen(false)}>
                  <p>Your Account</p>
                </NavLink>
                <p>Help Center</p>
                <p>Contact</p>
      ...
      {/* Modal for "Post Your Room" */}
      <Modal
        open={isPostYourRoomModalOpen}
        onCancel={closePostYourRoomModal}
        footer={null}
      >
        <h3 style={{ textAlign: "center" }}>Post Your Room From Here</h3>
        <PostYourRoom onClose={closePostYourRoomModal} />
